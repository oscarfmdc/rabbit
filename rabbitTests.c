...
int main(int argc, char* argv[])
{
	...
	cc_byte out1[16]  = { 0xED, 0xB7, 0x05, 0x67, 0x37, 0x5D, 0xCD, 0x7C,
							0xD8, 0x95, 0x54, 0xF8, 0x5E, 0x27, 0xA7, 0xC6 };


	rabbit_instance r_master_inst, r_inst;
	cc_byte buffer[16] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			              0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

    rabbit_key_setup(&r_master_inst, key1, 16);
    rabbit_iv_setup(&r_master_inst, &r_inst, iv1, 8);
    rabbit_cipher(&r_inst, buffer, buffer, 16);
	...
	if(test_if_equal(buffer, out1, 16))
		printf("Es el resultado esperado \n");
   return 0;
